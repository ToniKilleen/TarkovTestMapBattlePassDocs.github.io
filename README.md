...
- **🗺 12 Локаций:** Лаборатория, Таможня, Улицы, Развязка, Берег, Резерв, Лес, Маяк, Завод, Эпицентр, **Терминал (Ледокол)**, **Лабиринт**
- **📄 9 Типов документов:**
...
> Если у тебя карты Терминала еще нет — можешь пока скачать заглушки с [MapGenie](https://mapgenie.io/tarkov) или оставить пустыми, будет показываться "Карта не найдена", но остальной функционал работает.
...
const CHANGELOG = [
  {
    ...
    changes: [
      '➕ Добавлены карты Терминал и Лабиринт',
      '📖 Улучшен README',
